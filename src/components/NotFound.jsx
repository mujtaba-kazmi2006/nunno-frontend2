    ...
    return (
        <div className="min-h-[100dvh] bg-[#020205] text-white flex items-center justify-center p-6 relative overflow-hidden font-sans">
            ...
            <div className="absolute inset-0 pointer-events-none">
                <div className="absolute top-1/4 left-1/4 size-[400px] bg-violet-600/5 blur-[100px] rounded-full animate-pulse" />
                <div className="absolute bottom-1/4 right-1/4 size-[400px] bg-violet-600/5 blur-[100px] rounded-full animate-pulse" style={{ animationDelay: '1s' }} />
            </div>
            ...
            <div className="relative z-10 max-w-2xl w-full text-center">
                ...
                >
                    <div className="inline-flex items-center justify-center size-24 rounded-[3rem] bg-white/[0.02] border border-white/5 text-violet-500 mb-12 shadow-2xl relative group overflow-hidden">
                        <div className="absolute inset-0 bg-violet-500/10 opacity-0 group-hover:opacity-100 transition-opacity blur-xl" />
                    ...
                    <h1 className="text-[15vw] md:text-[8rem] font-black italic uppercase tracking-tighter leading-none mb-4 md:mb-8 text-white">
                        404<span className="text-violet-600">.</span>
                    </h1>

                    <h2 className="text-2xl md:text-3xl font-black italic uppercase tracking-tight mb-6\">
                        Lost in <span className="text-slate-500 underline decoration-violet-600 underline-offset-8 transition-colors hover:text-white\">the Void.</span>
                    </h2>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center px-4">
                        <Link
                            to="/"
                            className="px-10 py-5 bg-white text-black rounded-2xl font-black uppercase tracking-widest text-xs italic hover:bg-violet-600 hover:text-white transition-all active:scale-95 flex items-center justify-center gap-3 shadow-xl shadow-black/40"
                        >
                            <ArrowLeft size={16} />
                            Return to Reality
                        </Link>
