        ...
        <AnimatePresence>
            {isOpen && (
                ...
                >
                    <div className="relative">
                        ...
                        <svg width="128px" height="96px" viewBox="0 0 64 48" className="overflow-visible">
                            ...
                            <polyline
                                ...
                                className="fill-none stroke-purple-500/10 stroke-[3] stroke-round stroke-join"
                            />
                            {/* Front line (active pulse) */}
                            <motion.polyline
                                points="0.157 23.954, 14 23.954, 21.843 48, 43 0, 50 24, 64 24"
                                className="fill-none stroke-purple-500 stroke-[3] stroke-round stroke-join"
                    ...
                    >
                        <span className="text-[10px] font-black uppercase tracking-[0.5em] text-purple-500 italic animate-pulse">
